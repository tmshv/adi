package ru.gotoandstop.adi.dialogs{
	import adiwars.clips.BattleWinClip;
	...
	public class WinnerDialog extends Dialog{
		private var view:BattleWinClip;
		
		public function WinnerDialog(money:uint, experience:uint, context:Context){
			super(context);
			
			this.view = new BattleWinClip();
